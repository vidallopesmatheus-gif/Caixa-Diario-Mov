...
namespace CaixaDiario.API.Migrations
{
    ...
    [Migration("20260911014023_AdicionarCartaoDeCredito")]
    partial class AdicionarCartaoDeCredito
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaixaDiario.API.Models.Categoria", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CaixaDiario.API.Models.Grupo", b =>
                {
                    ...
                    b.HasIndex("Bloco", "Ordem");

                    b.ToTable("grupos", (string)null);
                });

            modelBuilder.Entity("CaixaDiario.API.Models.LinkConciliacao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("TotalClassificadosPeloCliente")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("total_classificados_pelo_cliente");
                    ...
                    b.ToTable("links_conciliacao", (string)null);
                });
            ...
            modelBuilder.Entity("CaixaDiario.API.Models.MetaAnual", b =>
                {
                    ...
                    b.Property<Guid?>("ContaInvestimentoId")
                        .HasColumnType("uuid")
                        .HasColumnName("conta_investimento_id");
                    ...
                    b.Property<string>("IconeSonho")
                        .HasColumnType("text");

                    b.Property<decimal?>("MargemPJ")
            ...
            modelBuilder.Entity("CaixaDiario.API.Models.PagamentoFatura", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("ContaCartaoId")
                        .HasColumnType("uuid")
                        .HasColumnName("conta_cartao_id");
                    ...
                    b.HasIndex("ContaCartaoId", "Competencia");
            ...
            modelBuilder.Entity("CaixaDiario.API.Models.RegraCategorizacao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("ContaContrapartidaId")
                        .HasColumnType("uuid")
                        .HasColumnName("conta_contrapartida_id");
                    ...
                    b.Property<string>("CriterioTipo")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("criterio_tipo");

                    b.Property<string>("CriterioValor")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("criterio_valor");

                    b.Property<string>("DescricaoReferencia")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("descricao_referencia");
                    ...
                    b.HasIndex("ContaContrapartidaId");

                    b.HasIndex("ClienteId", "ContaBancariaId", "Tipo", "Ativa");
            ...
            modelBuilder.Entity("CaixaDiario.API.Models.TransacaoImportada", b =>
                {
                    ...
                    b.ToTable("transacoes_importadas", (string)null);
                });

            modelBuilder.Entity("CaixaDiario.API.Models.Transferencia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CaixaDiario.API.Models.Categoria", b =>
                {
                    b.HasOne("CaixaDiario.API.Models.Grupo", "Grupo")
                        .WithMany()
            ...
            modelBuilder.Entity("CaixaDiario.API.Models.MetaAnual", b =>
                {
                    ...
                    b.HasOne("CaixaDiario.API.Models.ContaBancaria", "ContaInvestimento")
                        .WithMany()
                        .HasForeignKey("ContaInvestimentoId");

                    b.Navigation("Cliente");

                    b.Navigation("ContaInvestimento");
                });
            ...
            modelBuilder.Entity("CaixaDiario.API.Models.PagamentoFatura", b =>
                {
                    ...
                    b.HasOne("CaixaDiario.API.Models.ContaBancaria", "ContaCartao")
                        .WithMany()
                        .HasForeignKey("ContaCartaoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CaixaDiario.API.Models.ContaBancaria", "ContaOrigem")
                        .WithMany()
            ...
            modelBuilder.Entity("CaixaDiario.API.Models.RegraCategorizacao", b =>
                {
                    ...
                    b.HasOne("CaixaDiario.API.Models.ContaBancaria", "ContaContrapartida")
                        .WithMany()
                        .HasForeignKey("ContaContrapartidaId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("ContaContrapartida");
                });
            ...
            modelBuilder.Entity("CaixaDiario.API.Models.Transferencia", b =>
                {
                    ...
                    b.HasOne("CaixaDiario.API.Models.ContaBancaria", "ContaDestino")
                        .WithMany()
